               ...
               <div className="row">
                  <div className="col-xl-12 col-lg-12">
                     <div className="blog__details-wrapper mr-50">
                        ...
                        <div className="blog__text mb-40">
                           <h3>Arttech İle Mobil Yaşam</h3>
                           <p>Gelişen teknolojiyle birlikte hayatımıza giren yeniliklerden biri olan led aydınlatma, bilindiği gibi enerjiyi daha verimli kullanarak aydınlatma sağlamaktadır.</p>
                        ...
                        <div className="blog__text mb-40">
                           <h3>Gelişmiş İklimlendirme Kontrolü</h3>
                        ...
                        <div className="blog__text mb-40">
                           ...
                           <p>ARTTECH size daha fazla konfor sunmak için tv, uydu alıcı, blu-ray oynatıcı, ses sistemi gibi multimedya cihazlarını uzaktan kumanda kullanmadan kontrol etme olanağı sağlar. Elektronik cihazlarınız için ayrı ayrı uzaktan kumanda kullanmanıza gerek yok, esnek akıllı kumanda özelliği sayesinde tüm cihazlarınızı inohom ile kontrol edebilirsiniz. Multimedya sistemlerinizi isterseniz senaryolar ile otomatik olarak kontrol edebilirsiniz. Eve geldiğinizde istediğiniz tv kanalı açılabilir, akşam yemeğine sevdiğiniz müzik ile başlayabilirsiniz.</p>
